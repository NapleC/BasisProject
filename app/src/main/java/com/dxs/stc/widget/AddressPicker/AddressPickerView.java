package com.dxs.stc.widget.AddressPicker;
...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        defaultSelectedColor = ContextCompat.getColor(mContext, R.color.defaultSelectedColor);
        defaultUnSelectedColor = ContextCompat.getColor(mContext, R.color.defaultUnSelectedColor);
        defaultSureUnClickColor = ContextCompat.getColor(mContext, R.color.defaultSureUnClickColor);
        defaultSureCanClickColor = ContextCompat.getColor(mContext, R.color.defaultSureCanClickColor);
        // UI
