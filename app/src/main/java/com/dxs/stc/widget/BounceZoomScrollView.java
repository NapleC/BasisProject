 ...
 *
 * @version V1.0 // 仿 ios 可上提下拉的 ScrollView
 * @copyright https://blog.csdn.net/KokJuis/article/details/62046834
...
public class BounceZoomScrollView extends ScrollView {
    ...
    private View dropZoomView;// 需要被放大的 view
    private int dropZoomViewWidth;
    private int dropZoomViewHeight;
    //---- 头部收缩属性 end--------

    //------ 尾部收缩属性 --------
    private View inner;// 子 View
    private float y;// 点击时 y 坐标
    ...
    private boolean upDownSlide = false; // 判断上下滑动的 flag
    //------ 尾部收缩属性 end--------
    ...
    private void init() {
        ...
        if (getChildAt(0) != null) {
            inner = getChildAt(0);// 这个是底部收缩的 view
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                // 尾部处理
                final float preY = y;// 按下时的 y 坐标
                float nowY = ev.getY();// 时时 y 坐标
