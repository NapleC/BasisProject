...
public class RoundCornerRelativeLayout extends RelativeLayout {
    ...
    public RoundCornerRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundCornerFrameLayout);
            float radius = ta.getDimension(R.styleable.RoundCornerFrameLayout_frameRadius, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundCornerFrameLayout_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundCornerFrameLayout_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundCornerFrameLayout_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundCornerFrameLayout_bottomRightRadius, radius);
            ta.recycle();
        }
