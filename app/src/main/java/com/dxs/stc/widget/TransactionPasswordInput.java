 ...
 * com.dxs.stc.widget.TransactionPasswordInput
 *
 * @version V1.0 交易密码输入框
 */
public class TransactionPasswordInput extends AppCompatEditText {
    ...
    public TransactionPasswordInput(Context context) {
        super(context);
        setAttr(null, 0);
        init();
    }

    public TransactionPasswordInput(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttr(attrs, 0);
        init();
    }

    public TransactionPasswordInput(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setAttr(AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = a.getColor(R.styleable.PasswordInputEdt_textColor, 0xff333333);
        rectNormalColor = a.getColor(R.styleable.PasswordInputEdt_rectNormalColor, 0xffc9caca);
        rectChooseColor = a.getColor(R.styleable.PasswordInputEdt_rectChooseColor, 0xffE9A331);
