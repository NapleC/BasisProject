 ...
 * <p>
 * <p>You can also add items to XTabLayout in your layout through the use of {@link TabItem}.
 * An example usage is like so:</p>
 * <p>
 * <pre>
 * &lt;android.support.design.widget.XTabLayout
...
public class XTabLayout extends HorizontalScrollView {
    ...
    // 当 Tab 被选中时文本长度大于等于 Tab 的宽度时，
    // Tab 会另外增加 SELECT_TAB_SELECTED_ADD_WIDTH 的长度
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
     ...
     *
     * @param width
     * @param height 当 height =0 时，则分割线长度占满
     */
