...
import com.dxs.stc.adpater.AuctionRecordAdapter;
...
public class AuctionRecordActivity extends CompatStatusBarActivity implements IBookView {
    ...
    private void initView() {
        mTitleCenter.setText(getString(R.string.auction_record));
        mData = new ArrayList<>();

        mTabLayout.addTab(mTabLayout.newTab().setText(getString(R.string.participate)));
        mTabLayout.addTab(mTabLayout.newTab().setText(getString(R.string.deal)));

        iGetBookPresenter = new GetBookPresenterImpl(this);
        mAdapter = new AuctionRecordAdapter(R.layout.item_auction_record, mData);
