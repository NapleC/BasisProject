...
import com.dxs.stc.adpater.AuctionHistoryAdapter;
...
public class AuctionHistoryListActivity extends CompatStatusBarActivity implements IBookView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auction_history_list);
    ...
    private void initView() {
        ...
        mAdapter = new AuctionHistoryAdapter(R.layout.item_auction_book, mData);
