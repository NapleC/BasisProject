...
public class NoticeListActivity extends CompatStatusBarActivity implements IBookView {
    ...
    private void initView() {
        ...
        mAdapter.setOnItemClickListener((adapter, view, position) -> {
            Loger.debug("预告列表");
            startActivity(new Intent(NoticeListActivity.this, NoticeDetailsActivity.class));
        });
    }
