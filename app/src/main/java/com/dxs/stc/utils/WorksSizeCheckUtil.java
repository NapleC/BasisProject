 ...
 * com.dxs.stc.utils.WorksSizeCheckUtil
 *
 * @version V1.0  监听et的工具类
 */
public class WorksSizeCheckUtil {
        ...
        private class textChange implements TextWatcher {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (checkAllEdit()) {
                    ...
                    mChangeListener.textChange(true, s.length());
                } else {
                    Log.i("TAG", "有edittext没值了");
                    mChangeListener.textChange(false, s.length());
                }
            }
        }
    ...
    public interface IEditTextChangeListener {
        void textChange(boolean isHadContent, int contentLength);
    }
}
