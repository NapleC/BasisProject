 ...
 * com.dxs.stc.utils.CountDown
 *
 * @version V1.0
 * https://github.com/sfyc23/CountDownList/blob/master/app/src/main/java/com/sfyc/countdownlist/CountDownCustomActivity.java
 *
        ...
        public void handleMessage(Message msg) {
            synchronized (CountDown.this) {
                ...
                if (millisLeft <= 0) {
                    ...
                    // 考虑用户的 onTick 需要花费时间, 处理用户 onTick 执行的时间
                    long delay = lastTickStart + mCountdownInterval - SystemClock.elapsedRealtime();

                    // 特殊情况：用户的 onTick 方法花费的时间比 interval 长，那么直接跳转到下一次 interval
